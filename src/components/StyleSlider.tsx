...
const STYLES: { id: string; label: string; description: string; url: string }[] = [
  {
    id: "editorial",
    label: "Editorial",
    description: "High-contrast, magazine-ready with dramatic shadows",
    url: "https://res.cloudinary.com/dnhcs54zz/image/upload/v1773420190/menushoot/transforms/u3tbgqmlixnsivxyr99c.png",
  },
  {
    id: "natural",
    label: "Natural",
    description: "True-to-life, bright and clean",
    url: "https://res.cloudinary.com/dnhcs54zz/image/upload/v1773420158/menushoot/transforms/gcviqjyke3lw30usttmo.png",
  },
  {
    id: "moody",
    label: "Moody",
    description: "Dark, atmospheric, cinematic depth",
    url: "https://res.cloudinary.com/dnhcs54zz/image/upload/v1773420077/menushoot/transforms/g4a0hn6gkjrcfdxwm44o.png",
  },
  {
    id: "warm",
    label: "Warm & Golden",
    description: "Golden tones, inviting and appetizing",
    url: "https://res.cloudinary.com/dnhcs54zz/image/upload/v1773420016/menushoot/transforms/ogi8ambdgv7dcf47ynbo.png",
  },
  {
    id: "minimal",
    label: "Minimal",
    description: "Clean, white-space focused, app-ready",
